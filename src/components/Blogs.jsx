    ...
    <div className='px-20 mt-20 mb-20'>
      ...
      <div className='grid grid-cols-3 gap-10 font-poppins'>
            <div className='border-2 rounded-lg p-5 space-y-4 transform transition-transform duration-300 hover:scale-105'>
                ...
                <div className='text-mutedGrayBlue'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since.</div>
                <div >
