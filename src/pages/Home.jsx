        ...
        <div className="">
          ...
          <div className="flex gap-3 font-montserrat mt-10">
            ...
            <div className="space-y-2">
              <p>
                we are not just IT experts, we are your strategic partners in
                navigating the ever
              </p>
              <p>
                evolving landscape of technology and transformation. With a deep
                passion for{" "}
              </p>
              <p>
                innovation and a commitment to excellence, we empower businesses
                to harnessr
              </p>
              <p>
                the power of digital technology to drive growth and redefine
                their success.
              </p>
            </div>
          </div>
